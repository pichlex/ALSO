...
def train(
    ...
    adaptive_beta = config.get("adaptive_batch_beta", None)
    ...
    prev_batch_size: Optional[float] = init_batch_size
            ...
            if log_to_mlflow:
                ...
                if var_used is not None and denom_used is not None:
                    ...
                    if ratio_smoothed is not None:
                        mlflow.log_metric("adaptive_batch/ratio_ema", ratio_smoothed, step=e)
        else:
            current_train_loader = train_dataloader
            var_used = None
            denom_used = None
            prev_batch_size = init_batch_size
