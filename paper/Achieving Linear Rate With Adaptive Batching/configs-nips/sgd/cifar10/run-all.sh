...
cd "${WORKDIR}"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs1024-seed0.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs1024-seed1.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs1024-seed2.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs16-seed0.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs16-seed1.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs16-seed2.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs256-seed0.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs256-seed1.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs256-seed2.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs512-seed0.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs512-seed1.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs512-seed2.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs64-seed0.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs64-seed1.json"
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/aboba/abm1/bs64-seed2.json"
...
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/basic/bs256-seed0.json"
...
"${UV_BIN}" run "${MAIN_PATH}" --config "${CONFIG_DIR}/seesaw/bs64-seed0.json"
